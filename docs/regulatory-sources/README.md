...
5. **IFC Performance Standards + EHS Guidelines** (`05-ifc-performance-standards/`, `06-ifc-ehs-guidelines/`) — the deep reference for project finance loans. NRB §6 explicitly names IFC PS as "good practice"; the demo's Annex 5b PF screening (85 questions across 8 areas) maps 1:1 to PS1–PS8. When a project-finance question in the wizard cites "IFC PS3 §12", these are the PDFs to open.
